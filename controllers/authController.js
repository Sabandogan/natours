...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // 3) If evertyhin ok , send token to client
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!currrentUser) {
    return next(
      new AppError(
        'The token belonging to this token does no longıer exist',
        401
      )
    );
  }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    return next(
      new AppError(
        'THERE WAS AN ERROR SENDİNG YHE EMAİL . TRY AGAİN LATER',
        500
      )
    );
  }
