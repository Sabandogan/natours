...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FiYW40NyIsImEiOiJjbWlrdmxybmIwZWRwM21yMXVsa3Uya2JiIn0.6KH5FrRClMlYMJYrGxGA2g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/saban47/cmimuv1ok00br01sa97q41amk',
    scrollZoom: false
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status = 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated succesfly"));
          }
          _context.n = 3;
          break;
        case 2:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51SdbOyEPeVUDT31WDfrD6xrK3ODDgPSA9MdYxBriOD6IpLnlnW4CHEhlUCTIluvU1fFbTVMU9VBF2BzjXbwCRWFn00YFYedJGc');
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processingg...';
    var tourId = e.target.dataset.tourId;
    (0, _stripe.bookTour)(tourId);
  });
}
console.log('script burada aaaa');
